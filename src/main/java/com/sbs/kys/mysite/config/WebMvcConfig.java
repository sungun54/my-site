package com.sbs.kys.mysite.config;
...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(needToLoginInterceptor).addPathPatterns("/**").excludePathPatterns("/")
				...
				.excludePathPatterns("/usr/member/loginIdDup").excludePathPatterns("/usr/member/emailDup")
				.excludePathPatterns("/usr/member/nicknameDup").excludePathPatterns("/usr/article/*-list")
				.excludePathPatterns("/usr/article/*-detail").excludePathPatterns("/usr/reply/getForPrintReplies")
				.excludePathPatterns("/usr/file/streamVideo");
