...
<div>
	<span><a href="javascript:popupOpen();">아이디 찾기</a></span><span><a
		href="javascript:popupOpen2();">비밀번호 찾기</a></span>
</div>
</div>

<script type="text/javascript">
	function popupOpen() {
		var popUrl = "${pageContext.request.contextPath}/usr/member/findLoginId"; //팝업창에 출력될 페이지 URL
